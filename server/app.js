...
let items = [
  ...
  {
    id: 2,
    name: "Квdfgdfgартира в центре",
    description: "Просторнcxzczxcая квартира в центре города",
    location: "Моffdsfсква",
    type: "Недfdsfsвижимость",
    propertyType: "Кварvxczvxcvтира",
    area: 1020,
    rooms: 32,
    price: 1501100000,
  },
